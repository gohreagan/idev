...
<li class="list-group-item"><label style="width:100%;"><a href="{$base_url}/adview.php?id={$html_link_results[nr].html_link_id}" class="btn btn-mini btn-primary fancy-page">{$html_view_link}</a><br/><br/>{$marketing_source_code}</label><br/><textarea rows="8" class="form-control" style="direction: ltr !important;">{$html_link_results[nr].html_link_url}</textarea></li>
</ul>
