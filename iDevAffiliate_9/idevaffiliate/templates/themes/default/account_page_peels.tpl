...
<textarea rows="4" class="form-control" style="direction: ltr !important;"><script src="{$peel_link_results[nr].peel_source_location}/jquery-2.0.3.min.js"></script>
...
<textarea rows="4" class="form-control" style="direction: ltr !important;"><script src="{$peels_link_results[nr].peels_source_location}/jquery-2.0.3.min.js"></script>
