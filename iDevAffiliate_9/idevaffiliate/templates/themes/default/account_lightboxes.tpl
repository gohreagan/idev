...
<ul class="list-group">
<li class="list-group-item"><label style="width:100%;">{$lb_head_description}</label><br /><br />{$lb_head_source_code}<br /><br /><textarea rows="6" class="form-control" style="direction: ltr !important;"><link rel="stylesheet" href="{$install_url}/templates/source/lightbox/css/jquery.fancybox.css" type="text/css" />
...
<textarea rows="4" class="form-control" style="direction: ltr !important;">{$lightbox_link_results[nr].lightbox_code}</textarea></li>
</ul>
