...
<div class="portlet-heading" style="background:{$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$qr_chosen_group_name}</h4></div></div>
<div class="portlet-body">
