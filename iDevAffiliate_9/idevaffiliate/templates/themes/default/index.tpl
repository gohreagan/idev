...
<div class="row">
<div class="col-md-{if !isset($affiliateUsername)}7{else}12{/if}" style="margin-top:15px;">
...
<div class="portlet portlet-basic">
<div class="portlet-heading"><div class="portlet-title"><h4>{$index_login_title}</h4></div></div>
<div class="portlet-body">
<form method="post" action="login.php">      
<div class="form-group">
<label for="userid">{$index_login_username}</label>
...
<div class="form-group">
<label for="password">{$index_login_password}</label>
...
<button type="submit" class="btn btn-inverse">{$index_login_button}</button>
...
{if !isset($cp_page_width)}<p style="margin-top:25px;"><a href="signup.php" class="btn btn-block btn-danger">{$header_signupLink}</a></p>{/if}
</div>
{/if}
...
<div class="portlet-heading" style="background:{$portlet_3};"><div class="portlet-title" style="color:{$portlet_3_text};"><h4>{$index_table_title}</h4></div></div>
<div class="portlet-body">
...
<div class="portlet" style="border-color:{$portlet_3};">
<div class="portlet-heading" style="background:{$portlet_3};"><div class="portlet-title" style="color:{$portlet_3_text};"><h4>{$chart_last_6_months}</h4></div></div>
<div class="portlet-body">
...
<div class="portlet" style="border-color:{$portlet_3};">
<div class="portlet-heading" style="background:{$portlet_3};"><div class="portlet-title" style="color:{$portlet_3_text};"><h4>{$chart_this_month}</h4></div></div>
<div class="portlet-body">
