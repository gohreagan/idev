...
<h1 style="color:{$heading_text};">{$pic_title}</h1>
</div>
...
<div class="portlet-heading" style="background:{$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$pic_current}</h4></div></div>
<div class="portlet-body">
