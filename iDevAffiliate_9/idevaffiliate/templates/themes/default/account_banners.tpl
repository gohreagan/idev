...
<li class="list-group-item"><label style="width:100%;">{$banner_link_results[nr].banner_display}<br /><br/>{$marketing_source_code}</label><br/><textarea rows="4" class="form-control" style="direction: ltr !important;">{$banner_link_results[nr].banner_code}</textarea></li>
</ul>
