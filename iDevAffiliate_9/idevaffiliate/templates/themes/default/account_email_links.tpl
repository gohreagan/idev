...
<ul class="list-group">
<li class="list-group-item"><div class="alert alert-info"><label style="width:100%;">{$email_ascii}</label><br/><textarea rows="2" class="form-control" style="direction: ltr !important;">{$email_chosen_url}</textarea><br />{$email_source}<br /></div></li>
<li class="list-group-item"><div class="alert alert-warning"><label style="width:100%;">{$email_html}</label><br/><textarea rows="2" class="form-control" style="direction: ltr !important;"><a href="{$email_chosen_url}{$rel_values}">{$email_chosen_group_name}</a></textarea><br />{$email_source}</div></li>
</ul>
