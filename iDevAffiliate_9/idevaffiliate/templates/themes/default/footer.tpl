...
{/if}
	...
	{if isset($social_enabled)}
		...
		{section name=nr loop=$social_icons}<a href="{$social_icons[nr].link}" target="_blank" style="padding-right:5px;"><img src="{$social_icons[nr].image}" alt="{$social_icons[nr].name}" width="32" height="32" style="border:none;"></a>{/section}
        </div>
	{/if}
