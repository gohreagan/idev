...
<input class="form-control" type="text" name="custom_link" value="http://" style="direction: ltr !important;" />
</div>
...
<input class="btn btn-primary" type="submit" value="{$alternate_button}" name="{$alternate_button}" style="direction: ltr !important;">
</div>
