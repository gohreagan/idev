...
<h1 style="color:{$heading_text};">{$qr_code_title}</h1>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label">{$qr_code_size}</label>
<div class="col-sm-6">
...
<button type="submit" class="btn btn-primary">{$qr_code_button}</button>
</div>
</div>
...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$qr_chosen_group_name}</h4></div></div>
<div class="portlet-body">

<ul class="list-group">
<li class="list-group-item"><label>{$marketing_target_url}:</label> <a href="{$target_url}" target="_blank">{$target_url}</a></li>
<li class="list-group-item"><label>{$qr_image}</label></li>
<li class="list-group-item"><label>{$qr_code_offline_title}</label><br />{$qr_code_offline_content1}<br />{$qr_code_offline_content2}</li>
<li class="list-group-item"><label style="width:100%;">{$qr_code_online_title}</label><br />{$qr_code_online_content}<br /><br />
<textarea rows="4" class="form-control"><a href="{$url_only}" target="_blank"><img src="{$base_url}{$image_only}" style="border:none;" height="{$size_only}" width="{$size_only}" /></a></textarea></li>
</ul>
