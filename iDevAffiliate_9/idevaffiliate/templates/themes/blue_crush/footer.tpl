...
<div class="footer-content-end">
	...
	<div class="col-md-4"><a href="http://www.idevdirect.com{$affiliate_account}" target="_blank">{$footer_tag}</a></div>
...
<section class="footer_main">
    <section class="footer_nav" style="background-color: {$header_background};">
        <div class="container">
             <div id="footer_nav" class="collapse navbar-collapse navbar-responsive-collapse">
                ...
                {if isset($contact_link)}<li><a href="mailto:{$alternate_email_address}"  style="color: {$top_menu_text};"><span>{$header_emailLink}</span></a></li>{/if}
                   <li><a href="account.php"  style="color: {$top_menu_text};"><span >{$header_accountLink}</span></a></li>
                {if isset($use_faq) && ($faq_location == 1)}<li><a href="faq.php"  style="color: {$top_menu_text};"><span>FAQ</span></a>{/if}
    ...
    <section class="footer" style="background-color: {$header_background};">
        <div class="container">
            {if isset($show_footer_logo)}
            <div class="text-center footer-logo">
                <img alt="{$sitename}" src="{$main_logo}" />
            </div>
            {/if}
            <div class="text-center copyright">
                <p><a href="http://www.idevdirect.com{$affiliate_account}" target="_blank">{$footer_tag}</a>  |  {$footer_copyright} {php} echo date("Y"); {/php} <a href="{$siteurl}" target=_blank>{$sitename}</a> - {$footer_rights}</p>
            </div>
        </div>
    </section>
</section>
