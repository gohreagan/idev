...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$email_chosen_group_name}</h4></div></div>
<div class="portlet-body">
...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_5};"><div class="portlet-title" style="color:{$portlet_5_text};"><h4>{$email_notice}</h4></div></div>
<div class="portlet-body">
