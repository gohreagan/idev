...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_6};"><div class="portlet-title" style="color:{$portlet_6_text};"><h4>{$lb_head_title}</h4></div></div>
<div class="portlet-body">
...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$lightbox_link_results[nr].lightbox_group_name}</h4></div></div>
<div class="portlet-body">
