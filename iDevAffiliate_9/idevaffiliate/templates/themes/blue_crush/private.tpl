...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_5};"><div class="portlet-title" style="color:{$portlet_5_text};"><h4>{$private_required_heading}</h4></div></div>
