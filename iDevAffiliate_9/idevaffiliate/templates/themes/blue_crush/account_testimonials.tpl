...
<h1 style="color:{$heading_text};">{$testi_title}</h1>
</div>
...
<div class="form-group">
    <label class="col-sm-3 control-label" style="font-weight:normal;">{$testi_name}</label>
    <div class="col-sm-6">  
        <input  class="form-control" type="text" name="submit_name" value="{$submit_name}">
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label" style="font-weight:normal;">{$testi_url}</label>
    <div class="col-sm-6"> 
        <input  class="form-control" type="text" name="submit_website" value="{$submit_website}">
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label" style="font-weight:normal;">{$testi_content}</label>
    <div class="col-sm-6">      
...
{if $testimonials_security}
	<div class="form-group">
	<label class="col-sm-3 control-label" style="font-weight:normal;">{$testi_code}</label>
    <div class="col-sm-3">      
...
<button type="submit" class="btn btn-primary" name="iDevAffiliate">{$testi_submit}</button>
</div>
</div>
