...
<h1 style="color:{$heading_text};">{$logo_title}</h1>
</div>
...
<label class="col-sm-2 control-label">{$logo_file}</label>
<div class="col-sm-10">
...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$logo_current}</h4></div></div>
<div class="portlet-body">
