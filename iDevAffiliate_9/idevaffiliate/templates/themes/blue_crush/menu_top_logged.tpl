...
<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_general_stats} <i class="caret"></i></a>
...
{else}
<li style="background-color: {$cp_main_menu_color};"><a href="account.php?page=1" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_general_stats}</a></li>
{/if}

<li class="dropdown"  style="background-color: {$cp_main_menu_color};">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_heading_marketing} <i class="caret"></i></a>
<ul class="dropdown-menu dropdown-primary pull-left">
...
<li class="dropdown" style="background-color: {$cp_main_menu_color};">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_heading_custom_links} <i class="caret"></i></a>
<ul class="dropdown-menu dropdown-primary pull-left">
...
<li class="dropdown" style="background-color: {$cp_main_menu_color};">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_heading_training_materials} <i class="caret"></i></a>
<ul class="dropdown-menu dropdown-primary pull-left">
...
<li class="dropdown" style="background-color: {$cp_main_menu_color};">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_heading_commissions} <i class="caret"></i></a>
<ul class="dropdown-menu dropdown-primary pull-left">
...
{/if}
    ...
    {if isset($show_debits)}
	<li style="background-color: {$cp_main_menu_color};"><a href="account.php?page=46" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_pending_debits}</a></li>
    {/if}

<li style="background-color: {$cp_main_menu_color};"><a href="account.php?page=3" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_heading_history}</a></li>
<li style="background-color: {$cp_main_menu_color};"><a href="account.php?page=6" style="text-decoration: none; color:{$cp_main_menu_text};">{$menu_drop_heading_traffic}</a></li>
