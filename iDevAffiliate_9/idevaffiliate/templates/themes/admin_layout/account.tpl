...
<div class="left-area col-lg-3 clearfix nopad sidenav" id="mySidenav">
	<a href="javascript:void(0)" class="closebtn" onclick="closeNav()"><i class="fa fa-close"></i></a>
    <div class="sidebar clearfix"  style="background-color: {$cp_main_menu_color}">
	
    	<div class="profile-area clearfix">
        	<div class="pf-img"><img src="{$picture_details}" /></div>
            <div class="pf-name">
            	<h4>{$affiliate_firstname} {$affiliate_lastname}</h4>
            </div>
        </div>
...
{else}
<div class="content-area col-lg-9 col-md-12 nopad">
	<div class="cnt">
