...
<div class="panel-group nopad">
      <div class="panel panel-default" style="border-color:{$portlet_5};">
        <div class="panel-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_5};">
          <h4 class="panel-title" data-toggle="collapse" href="#contact" style="color:{$portlet_5_text};">
          {$private_required_heading}          </h4>
        </div>
