...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$banner_link_results[nr].banner_group_name}</h4></div></div>
<div class="portlet-body">
...
<div class="row">
<div class="col-md-12">
<div class="portlet banner-port" style="border-color:{$portlet_3};">
...
<div class="row">
<div class="col-md-12">
<div class="portlet banner-port" style="border-color:{$portlet_4};">
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_4};"><div class="portlet-title" style="color:{$portlet_4_text};"><h4>{$marketing_group_title}: {$banner_chosen_group_name}</h4></div></div>
<div class="portlet-body">
