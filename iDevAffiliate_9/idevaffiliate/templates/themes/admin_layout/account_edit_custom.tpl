...
<div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_1};"><div class="portlet-title" style="color:{$portlet_1_text};"><h4>{$custom_fields_title}</h4></div></div>
...
<div class="col-sm-5"><input class="form-control" type="text" name="custom_value" value="{$fields.custom_value}"></div>
<div class="col-sm-4"><input class="btn btn-sm btn-primary" type="submit" value="{$edit_custom_button}"></div>
</div>
</form>
