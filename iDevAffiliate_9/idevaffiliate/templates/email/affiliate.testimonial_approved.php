...
// ------------------------------------------------
$edata=$db->query("select aff_approve_testi_sub, aff_approve_testi_body from idevaff_email_$email_table_extension");
$indv_data=$edata->fetch();
$sub=$indv_data['aff_approve_testi_sub'];
$sub = preg_replace("/{company_name}/", "$sitename", $sub);
$con=$indv_data['aff_approve_testi_body'];
// ------------------------------------------------
