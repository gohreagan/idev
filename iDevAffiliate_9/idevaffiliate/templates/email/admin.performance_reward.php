...
$adata->execute(array($update_account_process));
...
$e=$indv_data['email'];
// ------------------------------------------------
$edata=$db->query("select admin_rew_subject, admin_rew_body from idevaff_email_english");
...
$mail->isHTML(true);
$content = nl2br($con) . "<br /><br />Username: " . $eusername . "<br /><br />--------<br />Message Auto-Sent By iDevAffiliate " . $version;
} else {
$mail->isHTML(false);
