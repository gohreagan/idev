...
$adata=$db->prepare("select id, username, password, f_name, l_name, email from idevaff_affiliates where username = ?");
...
$e=$indv_data['email'];
// ------------------------------------------------
$edata=$db->query("select admin_acct_subject, admin_acct_body from idevaff_email_english");
