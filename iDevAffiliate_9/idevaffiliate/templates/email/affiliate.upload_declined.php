...
// ------------------------------------------------
$edata=$db->query("select aff_img_dec_sub, aff_img_dec_body from idevaff_email_$email_table_extension");
$indv_data=$edata->fetch();
$sub=$indv_data['aff_img_dec_sub'];
$sub = preg_replace("/{company_name}/", "$sitename", $sub);
$con=$indv_data['aff_img_dec_body'];
// ------------------------------------------------
...
// ----------------------------------------------------------
$get_attachment = $db->query("select template_id, filename from idevaff_email_attachments where template_id = '9' and enabled = '1'");
