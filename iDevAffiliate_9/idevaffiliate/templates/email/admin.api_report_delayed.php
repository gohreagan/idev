...
$mail->isHTML(true);
$content = "iDevAffiliate Daily Delayed Commissions Report<br />----------------------------------------------------------------<br />Total Delayed Commissions In Queue: " . $total_delayed . "<br />Delayed Commissions Processed Today: " . $processing . "<br /><br />--------<br />Message Auto-Sent By iDevAffiliate " . $version;
} else {
$mail->isHTML(false);
$content = "iDevAffiliate Daily Delayed Commissions Report\n----------------------------------------------------------------\nTotal Delayed Commissions In Queue: " . $total_delayed . "\nDelayed Commissions Processed Today: " . $processing . "\n\n--------\nMessage Auto-Sent By iDevAffiliate " . $version;
}
...
if ($email_html_delivery == true) {
$mail->isHTML(true);
$content = "Invalid or missing secret key. No delayed commissions were processed.<br/><br />Key Used: ". $secret . "<br /><br />--------<br />Message Auto-Sent By iDevAffiliate " . $version;
} else {
$mail->isHTML(false);
