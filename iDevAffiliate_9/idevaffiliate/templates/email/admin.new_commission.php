...
$mail->isHTML(true);
$content = nl2br($con) . "<br /><br />Affiliate: " . $uname . "<br />" . $tier_add . "Order Number: " . $order_number . "<br />Commission Amount: " . $commission_amount . "<br />Commission Status: " . $commission_status . "<br /><br />" . $note_added . "<br /><br />--------<br />Message Auto-Sent By iDevAffiliate " . $version;
} else {
$mail->isHTML(false);
