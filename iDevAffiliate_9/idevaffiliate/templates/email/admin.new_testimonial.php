...
$e=$indv_data['email'];
// ------------------------------------------------
$edata=$db->query("select admin_new_testi_sub, admin_new_testi_body from idevaff_email_english");
$indv_data=$edata->fetch();
$sub=$indv_data['admin_new_testi_sub'];
$sub = preg_replace("/{company_name}/", "$sitename", $sub);
$con=$indv_data['admin_new_testi_body'];
// ------------------------------------------------
