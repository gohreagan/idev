...
$edata=$db->query("select aff_comm_gen_sub, aff_comm_gen_body from idevaff_email_$email_table_extension");
$indv_data=$edata->fetch();
$sub=$indv_data['aff_comm_gen_sub'];
$sub = preg_replace("/{company_name}/", "$sitename", $sub);
$con=$indv_data['aff_comm_gen_body'];
// ------------------------------------------------
...
if ($order_number == '') { $order_number = "N/A"; }
