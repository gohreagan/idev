...
$mail->isHTML(true);
$sendBody = "Dear Admin,<br /><br />Your commission processing file protection has been activated.<br /><br />Reason: " . $declined_content . "<br /><br />" . $ip_info . "<br /><br />--------<br />Message Auto-Sent By iDevAffiliate " . $version;
} else {
$mail->isHTML(false);
...
$mail->Subject = "iDevAffiliate Processing Protection Activated";
$mail->From = "$address";
