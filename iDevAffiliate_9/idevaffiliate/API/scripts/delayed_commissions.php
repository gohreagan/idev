...
// DO NOT EDIT BELOW UNLESS YOU WANT TO ALTER THE ACTIONS TAKEN DURING THE DELAYED COMMISSIONS PROCESS
// -----------------------------------------------------------------------------------------------------
...
if ($rewards == 1) { if (($rew_app == 1) || ($rew_app == 3)) { $update_account_process = $id;
...
// --------------------------------------------
	...
	$data_affiliate_id = $id;
	$data_order_number = $tracking_code;
